...
revealjs_presentation <- function(incremental = FALSE,
  ...
  if (is.character(reveal_plugins)) {
    ...
    supported_plugins <- c("notes", "search", "zoom", "chalkboard", "menu", "fullscreen", "embedtweet", "Animate", "audio-slideshow")
  ...
  pre_processor <- function(metadata, input_file, runtime, knit_meta, files_dir,
    ...
    # reveal.js
    revealjs_path <- system.file("reveal.js-4.1.x", package = "revealjs")
